...
`cloud-itonami-cofog-05.1` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
- the advisor cannot directly dispatch a robot action or commit a public
  record.
- the Waste Operations Governor remains independent of the advisor.
...
licensing the operator's jurisdiction requires for municipal waste collection work.
