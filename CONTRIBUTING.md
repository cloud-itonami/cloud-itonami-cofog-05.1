...
`cloud-itonami-cofog-05.1` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Waste Operations Governor.
- Treat municipal waste collection as a safety-relevant domain: add tests for permission,
